...
/// <summary>
/// Context for ContextMenuSub and its children.
/// </summary>
public class ContextMenuSubContext
{
    ...
    /// </summary>
    public ContextMenuSubContext? ParentContext { get; set; }

    /// <summary>
    /// Root context menu context. Used by items in sub-menus to close the entire context menu.
    /// </summary>
    public ContextMenuContext? RootMenuContext { get; set; }

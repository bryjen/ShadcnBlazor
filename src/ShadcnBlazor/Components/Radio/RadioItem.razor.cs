...
/// <summary>
/// Radio item for single selection within a RadioGroup.
/// </summary>
public partial class RadioItem : RadioSelectableComponentBase
{
    /// <summary>
    /// The unique identifier for this radio item, used for associating with a label via <c>for</c>.
    /// </summary>
    [Parameter]
